...
uint16_t black(void)
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(0,0,0)&~COLOR_ALPHA_MASK): 0;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(15,0,0)|COLOR_ALPHA_MASK) : 1;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(0,15,0)|COLOR_ALPHA_MASK) : 2;
}
...
uint16_t brown(void)
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(15,15,0)|COLOR_ALPHA_MASK) : 3;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(0,0,15)|COLOR_ALPHA_MASK) : 4;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(15,0,15)|COLOR_ALPHA_MASK) : 5;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(0,15,15)|COLOR_ALPHA_MASK) : 6;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(15,15,15)|COLOR_ALPHA_MASK) : 7;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(7,7,7)|COLOR_ALPHA_MASK) : 8;
}
...
uint16_t red(void)
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(31,0,0)|COLOR_ALPHA_MASK) : 9;
}
...
uint16_t green(void)
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(0,31,0)|COLOR_ALPHA_MASK) : 10;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(31,31,0)|COLOR_ALPHA_MASK) : 11;
}
...
uint16_t blue(void)
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(0,0,31)|COLOR_ALPHA_MASK) : 12;
}
...
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(31,0,31)|COLOR_ALPHA_MASK) : 13;
}
...
uint16_t cyan(void)
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(0,31,31)|COLOR_ALPHA_MASK) : 14;
}
...
uint16_t white(void)
{
    return (bpp_mode == 4) ? (COLOR_FROM_RGB5(31,31,31)|COLOR_ALPHA_MASK) : 15;
}
...
// ---------------------------------------------------------------------------
void draw_char(uint8_t chr, uint16_t x, uint16_t y)
{
    uint8_t i, j;
...
// ---------------------------------------------------------------------------
static void draw_char_at_cursor(uint8_t chr)
{
    if (chr == '\n') {
