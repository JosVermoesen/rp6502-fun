...
static void draw()
{
    ...
    fill_circle(random(black(), white()), canvas_width()/2, canvas_height()/2, canvas_width()/8);
    draw_hline(green(), canvas_width()/3, (canvas_height()/2), canvas_width()/3);
    draw_vline(red(), canvas_width()/2, 0, canvas_height());
    draw_line(yellow(), canvas_width()/3, canvas_height(), 2*canvas_width()/3, 0);
    draw_line(blue(), canvas_width()/3, 0, 2*canvas_width()/3, canvas_height());
    draw_rect(white(), canvas_width()/3, 0, (canvas_width()/3)+1, canvas_height());
    draw_circle(cyan(), canvas_width()/2, canvas_height()/2, canvas_width()/4);
    draw_rounded_rect(dark_cyan(), 0, 0, canvas_width()/4, canvas_height()/4, 10);
    fill_rounded_rect(random(black(), white()),
